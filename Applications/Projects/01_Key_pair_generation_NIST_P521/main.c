 ...
 * @brief   STSAFE-A120 NIST P521 Key pair & signature generation example
 ******************************************************************************
...
int main(void) {
    ...
    printf("\n\r----------------------------------------------------------------------------------------------------------------");
    printf("\n\r- This example demonstrates how to generate and use a NIST-P521 key pair on a target STSAFE-A120 device         -");
    printf("\n\r----------------------------------------------------------------------------------------------------------------");
    ...
    uint8_t slot_1_public_key[stse_ecc_info_table[STSE_ECC_KT_NIST_P_521].public_key_size];
