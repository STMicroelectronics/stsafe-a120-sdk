 ...
 * @brief   STSAFE-A120 BRAINPOOL P512 Key pair & signature generation example
 ******************************************************************************
...
int main(void) {
    ...
    printf("----------------------------------------------------------------------------------------------------------------");
    printf("\n\r-                              STSAFE-A120 BRAINPOOL-P512 key pair generation                                  -");
    printf("\n\r----------------------------------------------------------------------------------------------------------------");
    printf("\n\r- This example demonstrates how to generate and use a BRAINPOOL-P512 key pair on a target STSAFE-A120 device   -");
    printf("\n\r----------------------------------------------------------------------------------------------------------------");
    ...
    uint8_t slot_1_public_key[stse_ecc_info_table[STSE_ECC_KT_BP_P_512].public_key_size];
    ...
    uint8_t hash[HASH_SIZE(stse_ecc_info_table[STSE_ECC_KT_BP_P_512].min_signature_message_size)];
    printf("\n\n\r - Plain-text hash :");
